...
const destinations: Record<string,string> = {"portal_requests":"/atendimento","payments":"/financeiro","subscriptions":"/assinaturas","organizations":"/oficinas","benefit_redemptions":"/beneficios","service_orders":"/dashboard","appointments":"/visitas","promotions":"/promocoes","customers":"/clientes","account_erasure_requests":"/privacidade"};
