      ...
      {showUpdate && (
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-sm">Atualização do Portal Disponível</p>
              <p className="text-xs text-slate-300">
                Uma nova versão com melhorias operacionais está pronta. Atualize assim que finalizar sua ordem de serviço.
              </p>
            </div>
          </div>
